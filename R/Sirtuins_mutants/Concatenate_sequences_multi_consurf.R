...
seqinr::write.fasta(sequences = as.list(my_fasta_format), names = names(my_fasta_format), file.out = paste(my_path, "All_consurf_sequences_2024-06-14.fasta", sep = "/"), open = "w")

writeLines(text = names(my_fasta), con = paste(my_path, "All_consurf_sequences_header_2024-06-14.txt", sep = "/"))

writeLines(text = names(my_fasta_format), con = paste(my_path, "All_consurf_sequences_id_2024-06-14.txt", sep = "/"))
